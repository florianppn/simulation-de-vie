...
animals = {
    ...
    "Fennec": {"count": 10, "speed": 0, "move_size": 10, "damage": 1, "weight": 100, "food": 150, "drink": 150, "prey": ['Herb', 'Renard', 'Renardeau', 'Fennec', 'Autruche', 'Bizon', 'Bouc', 'Bouctin', 'Buffle', 'Canard', 'Chameau', 'Chat', 'Cheval', 'Chevre', 'Chien', 'Chinchila', 'Cochon', 'Licorne', 'Mouton', 'Oie', 'Pingoin', 'Poney', 'Raton', 'Sanglier', 'Singe', 'Souris', 'Vache']},
    ...
    "Renardeau": {"count": 1, "speed": 0, "move_size": 10, "damage": 1, "weight": 8, "food": 150, "drink": 150, "prey": ['Herb', 'Renard', 'Renardeau', 'Fennec', 'Autruche', 'Bizon', 'Bouc', 'Bouctin', 'Buffle', 'Canard', 'Chameau', 'Chat', 'Cheval', 'Chevre', 'Chien', 'Chinchila', 'Cochon', 'Licorne', 'Mouton', 'Oie', 'Pingoin', 'Poney', 'Raton', 'Sanglier', 'Singe', 'Souris', 'Vache']},
